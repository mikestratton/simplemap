  ...
  <body>
    ...
    <div id="panel">
      <div id="panel-content">
        ...
        <textarea name="geofield1" form="geoform" id="geojson-input" placeholder="Drag and drop GeoJSON onto the map or paste it here to begin editing." style="height:100%;">
            <?php echo $getGeo; ?>
        </textarea>
      </div>
    </div>
