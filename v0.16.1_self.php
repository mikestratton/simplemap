...
/*TODO:
If variable does not exist, page returns error "Undefined index"
undefined index is refering to the array: basename($FILES [][])
...
or 
b) isset
Entire upload code should be placed into a function
if index exists implement function
pseudo:
function uploadImage(){
	//enter code
}
if (array_key_exists('array key value', $array_name) {
	function uploadImage;
}
else {
	// move onto portion of code without upload function
}

Proposed solution:
Reference: http://stackoverflow.com/questions/4261133/php-notice-undefined-variable-and-notice-undefined-index
*/
$uploadOk = 1;
