...
<html>
  ...
  <body>
    ...
    <div id="panel">		
      <div id="panel-content">
		<div class="container">
			<div id="controls">
				<h2>Upload Image</h2>
				<form action="v0.17.php" method="post" enctype="multipart/form-data">
        ...
        <div id="geojson-controls">
          ...
          <form action="v0.17_geo_form.php" method="POST" id="geoform">
	...
	<script src="v0.17_geoeditor.js?t=<?php echo $timestamp; ?>" type="text/javascript"
